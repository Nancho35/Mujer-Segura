    ...
    loadMap() {        
        ...
        LocationService.getMyLocation().then((myLocation: MyLocation) => {
            ...
            let points: any[] = [
                ...
                { lat: 4.618220, lng: -74.077053, title: '<div><div></div><h1 style="color:#761C7F; font-family: "Segoe UI Semilight", "Segoe UI", Segoe, Tahoma, Helvetica, Arial, sans-serif;">Centro de Atención a Víctimas de Violencia Intrafamiliar (Cavif)</h1><div><p>Centro de Atención para mujeres víctimas de violencia intrafamiliar en cualquiera de sus formas con riesgo leve a moderado, con el objeto de poder interrumpir e iniciar proceso reparatorio a través de la intervención integral  tanto en aspectos psicológicos, sociales y legales.</p>Pagina Web <a href="https://www.fiscalia.gov.co/colombia/" target="_blank">https://www.fiscalia.gov.co/colombia/</a></p></div></div>' },
                { lat: 4.672545, lng: -74.073146, title: '<div><div></div><h1 style="color:#761C7F; font-family: "Segoe UI Semilight", "Segoe UI", Segoe, Tahoma, Helvetica, Arial, sans-serif;">Casa de la Justicia</h1><div><p>Las Casas de Justicia son centros interinstitucionales que aplican mecanismos de justicia formal y no formal, para orientar a los ciudadanos sobre sus derechos, prevenir el delito y velar por la sana convivencia en la ciudad a través de la resolución de conflictos </p>Pagina Web <a href="http://www.casasdejusticia.gov.co/" target="_blank">http://www.casasdejusticia.gov.co/</a></p></div></div>' }
